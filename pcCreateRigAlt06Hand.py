...
class pcCreateRigAlt06Fingers(UI):
    def __init__(self):
    ...
    def createCustom(self, *args):
        ...
        mc.text(l="Select The Fingers Joint: ")
        mc.text(l="")
        ...
        # mc.setParent("..")
        mc.radioButtonGrp("selFingersMirrorType_rbg", la2=["No", "Yes"], nrb=2, sl=1, cw2=[50, 50], )
        mc.text(l="")
        mc.setParent("..")
    ...
    def makeFingers(self, jointArray, leftRight, colourTU, *args):
    ...
    def tgpMakeBC(self, *args):
        ...
        jointArray = self.jointArray[:]
        print("jointArray: {0}".format(jointArray))
        ...
        if ((checkList[0] == "")):
            ...
            if mirrorRig:
                ...
                ctrlsArrayMirror, ctrlFingerNames = self.tgpCreateMirror(jntFingerNames, leftRightReplace,
